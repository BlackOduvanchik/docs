...
<Frame><img src="/images/atmos_ui/wallets/atmos_wallets_5wallets.png" alt="已导入钱包的钱包管理器" /></Frame>
...
| **标签系统** | 钱包和浏览器配置文件共享的[统一标签](/zh-Hans/additional-features/settings#tags) |
...
- 在一个视图中跟踪所有钱包余额
- 创建绑定到特定钱包的浏览器配置文件
- 使用[标签](/zh-Hans/additional-features/settings#tags)和批量操作整理钱包，例如选择、复制和删除
...
<CardGroup cols={2}>
  ...
  <Card title="标签" icon="tags" href="/zh-Hans/additional-features/settings#tags">
    钱包和配置文件共享的统一标签系统。
  </Card>
