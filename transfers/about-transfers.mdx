...
- **Wallet withdrawal** — send tokens from your wallets to other addresses

Both tools support templates, preview before execution, and deferred task scheduling via the [task manager](/task-manager/about-task-manager).

<Frame caption="Transfer module interface">
